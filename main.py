    ...
    for line in range(lines):
        ...
        for column in columns:
            ...
            if symbol != symbol_to_check:
                break
        else: # this will tell us if we didn't break out of the for loop
...
def spin(balance):
    ...
    print(f"You won on lines:", *winning_lines) # * is the splat or unpack operator it's gonna pass every line from winning_lines list to print this function
